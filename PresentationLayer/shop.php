...
<link href="css/bootstrap-shop.css" rel='stylesheet' type='text/css' />
...
<script src="js/jquery-shop.min.js"></script>
			  ...
			  <div class="col-md-12">
				 <div class="header-left">
					 ...
					 <div class="menu">
						  <a class="toggleMenu" href="#"><img src="images/nav.png" alt="" /></a>
							...
							<script type="text/javascript" src="js/responsive-shop-nav.js"></script>
				    </div>							
	    		    <div class="clear"></div>
	    	    </div>
	            <div class="header_right">
				  ...
				  <div class="search-box">
						...
						<!----search-scripts---->
						<script src="js/classie-shop.js"></script>
						<script src="js/uisearch-shop.js"></script>
						<script>
      ...
      <div class="shop_top">
		<div class="container">
			<div class="row shop_box-top">				
					<?php
						$sql = "SELECT event_name, event_date FROM event";
